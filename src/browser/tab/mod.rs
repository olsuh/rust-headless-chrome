...
use crate::protocol::cdp::Network::EmulateNetworkConditions;
...
impl Tab {
    ...
    pub fn bypass_wedriver(&self) -> Result<()> {
        self.call_method(AddScriptToEvaluateOnNewDocument {
            source: "Object.defineProperty(navigator, 'webdriver', {get: () => false });" //undefined
                .to_string(),
                world_name: None,
                include_command_line_api: None,
            })?;
    ...
    pub fn bypass_webgl_vendor(&self) -> Result<()> {
        let r = r#"const getParameter = WebGLRenderingContext.getParameter;
